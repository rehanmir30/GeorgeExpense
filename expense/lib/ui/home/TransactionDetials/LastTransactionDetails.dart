        ...
        child: SafeArea(
          child: Column(children: [
            ...
            Padding(
              ...
              child: GetBuilder<SqlController>(builder: (controller) {
                if(controller.recentTransactionsList?.isEmpty??true){
                  return const Center(child: Text("No recent transaction found"));
                }
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('${controller.recentTransactionsList![index].transactionName}',style:TextStyle(color: AppColor.kGrey.withOpacity(0.8),fontWeight: FontWeight.bold,fontSize: 21)),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children:  [
                              Text('\$ ${controller.recentTransactionsList![index].transactionAmount}',style:TextStyle(color: AppColor.kRed,fontWeight: FontWeight.bold,fontSize: 21)),
                              Text('${DateFormat('dd MMM').format(controller.recentTransactionsList![index].transactionDate)}',style:TextStyle(color: AppColor.kBlack,fontWeight: FontWeight.normal,fontSize: 18)),
            ...
            const SizedBox(height: 10,),
            if(Get.find<SqlController>().recentTransactionsList?.isNotEmpty?? false)Container(
