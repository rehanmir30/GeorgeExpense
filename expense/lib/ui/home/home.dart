          ...
          child: Column(
            children: [
              ...
              GetBuilder<DashBoardController>(builder: (controller) {
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      padding: (index==0)?const EdgeInsets.all(15):const EdgeInsets.all(0),
                      width: 10,
                      height: 20,
                      decoration: BoxDecoration(
                        shape:BoxShape.circle,
                        // borderRadius: BorderRadius.circular(10),
                        border: (index==0)?Border.all(color: AppColor.kWhite,width: 0):Border.all(color: AppColor.kBlack,width: 1),
                      ),
                      child: InkWell(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text('BALANCE',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.keyboard_arrow_up_outlined,color: AppColor.kWhite,),
                  ),
                  const SizedBox(width: 5,),
                  Container(
                    width: 30,
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children:  const [
                    Text("Monthly income:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
                    SizedBox(width: 15,),
                    Expanded(
                      child: SizedBox(
                          height: 50,
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:  const [
                    Text("Monthly expense:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
                    SizedBox(width: 15,),
                    Expanded(
                      child: SizedBox(
                          height: 50,
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:  const [
                    Text("Current balance:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: AppColor.kBlue),),
                    SizedBox(
                        height: 50,
                        width: 180,
                        child: TextField(
              ...
              Row(
                ...
                children: [
                  ...
                  RichText(
                      text: TextSpan(
                        text: "Today ",
                      style: const TextStyle(color: AppColor.kBlue,fontSize: 20,fontWeight: FontWeight.bold),
      
                      children: [
                     TextSpan(
                       text: "Candy",
                       style: TextStyle(color: AppColor.kBlack.withOpacity(0.6),fontSize: 20,fontWeight: FontWeight.bold),
                     )
      
                  ])),
      
                  const Text('\$60000',style: TextStyle(color: AppColor.kRed,fontSize: 20,fontWeight: FontWeight.bold),),
            ...
            AspectRatio(
              ...
              Row(
                ...
                children: [
                  ...
                  const Text('TOP MONTH EXPENSES:',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Text('TOP MONTH EXPENSES:',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ],
                      ),
      
                      const Text("\$25`00000",style: TextStyle(color: AppColor.kRed,fontSize: 18,fontWeight: FontWeight.bold),),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: const Text('SEE ALL',style: TextStyle(color: AppColor.kBlack,fontSize: 18),),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  const Text('RECORDATIONS:',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,letterSpacing: 2),),
                  const SizedBox(height: 10,),
              ...
              InkWell(
                ...
                children: [
                  ...
                  const Expanded(child: Text('PRODUCT EXPENSE SUMMARY:',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,letterSpacing: 2),textAlign: TextAlign.center,)),
                  const SizedBox(height: 10,),
